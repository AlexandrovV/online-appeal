                    ...
                    <form role="form" action="{{route('department-store')}}", method="post">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" id="exampleInput1" placeholder="Журналистика">
                            </div>
                            <div class="form-group">
                                <label for="exampleInput2">Тип департамента (полностью)</label>
                                <input type="text" name="departmentType" class="form-control" id="exampleInput2" placeholder="Цифровые трансформации">
                            </div>
                        </div>
                        <!-- /.card-body -->
