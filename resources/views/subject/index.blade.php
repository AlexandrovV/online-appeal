        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{route('subject-create')}}" class="btn btn-outline-primary"><i class="fas fa-plus-circle"></i> Создать новый</a>
                </div>
            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                    ...
                    <tr>
                        ...
                        <td><a href="{{route('subject-get', ['id' => $subject->id])}}">{{$subject->subject_name}}</a></td>
